...
ui <- fluidPage(
    # Application title
    h1(id="big-heading", "Calibration of 2-dimensional electrophoresis gels",img(src = "2DE_Template.png", height =30, width = 50) ),
    ...
    sidebarLayout(
        sidebarPanel(
            HTML('<p>For the calibration of pI | Mr-axes you can use manually given pI | Mr-values and distances (see below) or data stored in an external EXCEL-file. 
            Templates of <a href="https://github.com/kppleissner/GelCali/blob/main/GelCali_test_table.xlsx" target="_blank"> EXCEL-file (.xlsx)</a> and   <a href="https://github.com/kppleissner/GelCali/blob/main/2DE_Template1.PNG" target="_blank"> 2-DE Gel Image  (.png)</a> can be found on Github.
            <br> You can download the regression plot as a (.png) using the camera sign of plotly-functionalities visible by moving the mouse up above the regression curve. <br> The R-code is given on  <a href="https://github.com/kppleissner/GelCali/" target="_blank"> GitHub</a>.
                 '), 
            br(),
            br(),
            tags$b("Please enter distance and pI-values for selected protein spots:"),
            br(),
            ...
            textInput("y", "pI-values", value = "3.5, 4.2, 5.6, 7.3, 8.3,11", placeholder = "Enter values separated by a comma with decimals as points, e.g. 4.2, 4.4, 5, 5.03, etc."),
            hr(),
            tags$b("Please enter distance and Mr-values for selected protein spots:"),
            ...
            textInput("yy", "Mr-values", value = "80000, 15200, 25000, 33000, 36000, 14200", placeholder = "Enter values separated by a comma with decimals as points, e.g. 4.2, 4.4, 5, 5.03, etc."),
            hr(),
